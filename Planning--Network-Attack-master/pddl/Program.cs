...
namespace PDDL
{
    class Program
    {
        ...
        */
        ...
        static void TestNetworkAttack(string sBenchmarkPath, int cMachines, int cOS, int cExploits)
        {
            SDRPlanner.AddAllKnownToGiven = true;
            NetworkAttack na = new NetworkAttack(cMachines, cOS, cExploits);
            string sBenchmark = na.Name;
            na.WriteDomain(sBenchmarkPath + sBenchmark);
            na.WriteProblem(sBenchmarkPath + sBenchmark);
            SDRPlanner.TagsCount = 2;
            SDRPlanner.AddTagRefutationToGoal = false;
            TestBenchmark(sBenchmarkPath, sBenchmark, 25, true, false);
        }
        ...
        static void Main(string[] args)
        {
            ...
            Path = BASE_PATH + @"\PDDL\";
           // TestBattleship(sBenchmarkPath, 6);
            TestNetworkAttack(sBenchmarkPath, 3, 2, 2);
